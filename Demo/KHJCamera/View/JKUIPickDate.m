...
-(void)twoButton
{
    ...
    [buttonCancle setTitle:DeLocalizedString(@"allDate", nil) forState:UIControlStateNormal];
...
//    buttonSure.titleLabel.font = [UIFont systemFontOfSize:14];
    ...
    [buttonSure setTitle:DeLocalizedString(@"commit", nil) forState:UIControlStateNormal];
