//
//  KHJpath choice  KHJPathChoseView.m
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        dArray = [NSArray arrayWithObjects:DeLocalizedString(@"deviceSD", nil),DeLocalizedString(@"Cloud", nil),nil];
...
- (void)initView
{
    ...
    sLab.text = DeLocalizedString(@"recordPath", nil);
