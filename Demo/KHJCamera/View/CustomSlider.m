...
{
    self.thumbRect = [self.partRectArray[currentIndex] CGRectValue];
}
//画滑块
...
//    CGContextSetStrokeColorWithColor(context, self.sliderColor.CGColor);
    CGContextSetStrokeColorWithColor(context, ssRGB(82, 158, 154).CGColor);
//    if (i>self.value) {
//        [self.partColor set];
//    }else{
...
//    }
    ...
    for (int i = 0; i < self.partNameArray.count; i++) {
        ...
        CGFloat nameY = parRect.origin.y + self.partNameOffset.y+10;
