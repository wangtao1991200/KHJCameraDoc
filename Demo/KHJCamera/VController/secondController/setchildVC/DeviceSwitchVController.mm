...
#import "DeDeviceSwitchVController.h"
...
@interface DeDeviceSwitchVController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation DeDeviceSwitchVController
...
- (void)setMainView
{
    UILabel *tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 66)];
    ...
    TTableHeight = SCREEN_HEIGHT - (tipLabel.frame.origin.y+tipLabel.frame.size.height)-64;
    ttTable = [[UITableView alloc] initWithFrame:CGRectMake(0, tipLabel.frame.origin.y+tipLabel.frame.size.height, SCREEN_WIDTH, 60) style:UITableViewStylePlain];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DeSetStartAndEndTimeVController *sAndEndVC = [[DeSetStartAndEndTimeVController alloc] init];
...
{
    UIButton *but = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 60)];
    ...
    [but setTitleColor:KHJCcolor forState:UIControlStateNormal];
